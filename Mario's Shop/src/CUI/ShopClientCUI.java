...
public class ShopClientCUI {
	...
	public void gibMenueAus() {
		...
		System.out.println("Um sich anzumelden, drücken sie 'A'");
		System.out.println("Neukunde? Um sich zu registrieren drücken sie 'R'");
		System.out.println("");
		System.out.print(">>");
		input = liesEingabe();
		switch(input) {
	...
	public void shopKundeRegistrierung() {
		...
		for(Kunde k : liste) {
			while(k.getKundenNr() == kundenNr) {
				System.out.println("");
				System.out.println("Bitte wähle eine andere Kunden-Nr..");
				System.out.println("");
				System.out.print(">>");
				kundenNummer = liesEingabe();
				kundenNr = Integer.parseInt(kundenNummer);
